...
public class TreeSetDemo {
	...
	public static void main(String[] args) {
		...
		students.add(new com.tnsif_day18.TreeSet.Student(101, "Harshita", 87));
		students.add(new com.tnsif_day18.TreeSet.Student(104, "Pallavi", 71));
		students.add(new com.tnsif_day18.TreeSet.Student(103, "Anisha", 67));
		students.add(new com.tnsif_day18.TreeSet.Student(102, "Sheetal", 72));
